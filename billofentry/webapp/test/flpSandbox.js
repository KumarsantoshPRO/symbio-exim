		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bill of entry",
									"targetURL": "#zproskmittalcoineximbillofentrybillofentry-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zproskmittalcoineximbillofentrybillofentry-display": {
								"semanticObject": "zproskmittalcoineximbillofentrybillofentry",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpro.sk.mittalcoin.exim.bill.of.entry.billofentry",
									"url": sap.ui.require.toUrl("zpro/sk/mittalcoin/exim/bill/of/entry/billofentry")
								}
							}
						}
					}
