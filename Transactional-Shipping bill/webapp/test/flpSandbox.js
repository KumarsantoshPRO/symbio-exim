		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Transactional -Shipping bill",
									"targetURL": "#zmgproeximtransactionalshippingbillexim-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmgproeximtransactionalshippingbillexim-display": {
								"semanticObject": "zmgproeximtransactionalshippingbillexim",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmg.pro.exim.transactionalshippingbill.exim",
									"url": sap.ui.require.toUrl("zmg/pro/exim/transactionalshippingbill/exim")
								}
							}
						}
					}
